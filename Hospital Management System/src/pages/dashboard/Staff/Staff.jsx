...
function Staff({ showCreateForm, setShowCreateForm,showUpdateForm, setShowUpdateForm, setSelectedStaffId}) {
    ...
    const handleDelete = async (id) => {
        try {
            ...
            setStaff(medicine.filter(item => item.Emp_ID !== id));
        } catch (err) {
            console.log(err);
        }
    }
    ...
    <div className="table-responsive">
        <div className="py-8">
            <div>
                <h2 className="text-2xl font-semibold leading-tight">Staff List</h2>
            </div>
